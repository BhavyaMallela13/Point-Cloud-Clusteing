...
main (int argc, char** argv)
{
  ...
  float max_radius= 0.15;      // 0.15
  float nd_weight= 0.1;       // 0.1
  ...
  float min_cluster_distance= 1;
  float min_density= 400;
  float min_cylinder= 30;

  bool SWITH_VOXEL_GRID= true;
  bool SWITH_WRITE_CLUSTERS= true;
  ...
  reader.read ("Buildings_sampled.pcd", *cloud);
